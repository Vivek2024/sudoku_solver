...
test("Solve", function () {
  ...
  var puz_unsolvable =
    ...
    "....3.8...99";
  var puz_unsolvable2 =
    "5168497323.46.2...5.97...65135.6.9.7472591..696837." +
  ...
  // Board too big
  throws(function () {
    sudoku.solve(puz_too_big);
  }, "Invalid board size");

  // Board has invalid character
  throws(function () {
    sudoku.solve(puz_invalid_chars);
  }, "Invalid characters");
});
...
test("Get candidates map", function () {
  ...
  // Board too big
  throws(function () {
    sudoku._get_candidates_map(puz_too_big);
  }, "Invalid board size");

  // Board has invalid character
  throws(function () {
    sudoku._get_candidates_map(puz_invalid_chars);
  }, "Invalid characters");
});
...
test("Get square -> vals map", function () {
  ...
  deepEqual(
    sudoku._get_square_vals_map(puz),
    {
      A1: "4",
      A2: ".",
      A3: ".",
...
test("Get square -> peers map", function () {
  ...
  var units = sudoku._get_all_units(rows, cols);
  var square_units_map = sudoku._get_square_units_map(squares, units);
  var square_peers_map = sudoku._get_square_peers_map(
    squares,
    square_units_map
  );
...
test("Board grid -> string", function () {
  ...
  deepEqual(
    sudoku.board_grid_to_string(grid1),
    ".5.1972.8.9.2651.7217483596.4.3..7.9.3.7.98...796..32.981536472325974681764812953"
  );
  deepEqual(
    sudoku.board_grid_to_string(grid2),
    ".1.872.4..47695....651437..4217.8.3..7.2.4...58.9.12746583294171924873..734516..."
  );
  deepEqual(
    sudoku.board_grid_to_string(grid3),
    "23.94.67.8..3259149..76.32.1.....7925.321.4864..68.5317..1....96598721433...9...7"
  );
});
